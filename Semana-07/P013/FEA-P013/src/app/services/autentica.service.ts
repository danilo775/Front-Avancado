...
export class AutenticaService {
  ...
  signupUser(email: string, password: string) {
   return this.http.post<AuthResposeData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDAjofJjn45YWqieThRQmMT6fP5vMHeGsQ',
   {
      email: email,
      password: password,
  ...
  loginUser(email: string, password: string) {
    return this.http.post<AuthResposeData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDAjofJjn45YWqieThRQmMT6fP5vMHeGsQ',
    {
      email: email,
      password: password,
      returnSecureToken: true
